...
Blockly.Python['styles_ul'] = function(block) {
  var value_ul = Blockly.Python.valueToCode(block, 'ul', Blockly.Python);
  var statements_class = Blockly.Python.statementToCode(block, 'class');
  // TODO: Assemble Python into code variable.
  var code = '&lt;ul class ="'+value_ul+'"&gt;\n'
...
Blockly.Python['styles_li'] = function(block) {
  var value_li = Blockly.Python.valueToCode(block, 'li', Blockly.Python);
  var statements_class = Blockly.Python.statementToCode(block, 'class');
  // TODO: Assemble Python into code variable.
  var code = '&lt;li class ="'+value_li+'"&gt;\n'
